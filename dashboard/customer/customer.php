...
// pagination
$dataPerHalaman = 5;
$jumlahHalaman = ceil(count($data_user) / $dataPerHalaman);
$halamanAktif = isset($_GET["page"]) ? $_GET["page"] : 1;
$indexAwal = ($dataPerHalaman * $halamanAktif) - $dataPerHalaman;

$query = "SELECT * FROM user LIMIT $indexAwal, $dataPerHalaman";
...
$jumlahSemuaData = count($data_user);
        ...
        <nav>
            ...
            <div class="nav-main">
                ...
                <div class="nav-field-container">
                    ...
                    <a href="customer.php" class="nav-field active">
